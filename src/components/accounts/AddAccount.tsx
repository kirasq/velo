...
import { AddPop3Account } from "./AddPop3Account";
...
type View = "select-provider" | "gmail" | "imap" | "pop3" | "caldav";
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-text-tertiary mt-0.5">
                Download mail from a POP3 server, send via SMTP (keeps mail local)
              </div>
            </div>
          </button>
