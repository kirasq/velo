  ...
  return (
    <>
      <div className="flex items-center gap-1 px-3 py-3 border-b border-border-secondary bg-bg-secondary">
        ...
        {hasLastMessage && (
          <>
            <Button
              ...
              disabled={noReply}
              title={noReply ? t("threadActions.noReply") : defaultReplyMode === "replyAll" ? t("threadActions.replyAll") : t("threadActions.reply")}
            ...
            <Button
              ...
              disabled={noReply}
              title={noReply ? t("threadActions.noReply") : defaultReplyMode === "replyAll" ? t("threadActions.replyShortcut") : t("threadActions.replyAllShortcut")}
              className="disabled:opacity-40 disabled:hover:bg-transparent disabled:hover:text-text-secondary"
            />
            <Button
              variant="secondary"
        ...
        {/* Core actions group */}
        <Button variant="secondary" iconOnly icon={<Archive size={15} />} onClick={handleArchive} title={t("threadActions.archive")} />
        <Button variant="secondary" iconOnly icon={<Trash2 size={15} />} onClick={handleDelete} title={t("threadActions.delete")} />
        <Button
          variant="secondary"
          iconOnly
          icon={thread.isRead ? <Mail size={15} /> : <MailOpen size={15} />}
          onClick={handleToggleRead}
          title={thread.isRead ? t("threadActions.markUnread") : t("threadActions.markRead")}
        />
        <Button
          variant="secondary"
          iconOnly
          ...
          title={thread.isStarred ? t("threadActions.unstar") : t("threadActions.star")}
          className={thread.isStarred ? "text-warning" : ""}
        />
        <Button variant="secondary" iconOnly icon={<Clock size={15} />} onClick={() => setShowSnooze(true)} title={t("threadActions.snooze")} />
        <Button
          variant="secondary"
          iconOnly
          icon={<Ban size={15} />}
          onClick={handleSpam}
          title={isSpamView ? t("threadActions.notSpam") : t("threadActions.reportSpam")}
        />
        <Button
          variant="secondary"
          iconOnly
          ...
          title={t("threadActions.moveToFolder")}
        />
        <Button
          variant="secondary"
          iconOnly
          ...
          title={thread.isPinned ? t("threadActions.unpin") : t("threadActions.pin")}
        ...
        <Button
          ...
          title={thread.isMuted ? t("threadActions.unmute") : t("threadActions.mute")}
        ...
        {hasFollowUp ? (
          <Button
            ...
            title={t("threadActions.cancelFollowUp")}
          ...
          <Button
            ...
            title={t("threadActions.remindMe")}
          />
        )}
        {hasUnsubscribe && (
          <Button
            ...
            title={unsubscribeStatus === "loading" ? t("threadActions.unsubscribing") : unsubscribeStatus === "done" ? t("threadActions.unsubscribed") : t("threadActions.unsubscribe")}
        ...
        {/* Utility group */}
        <Button variant="secondary" iconOnly icon={<Printer size={15} />} onClick={onPrint} title={t("threadActions.print")} />
        <Button variant="secondary" iconOnly icon={<Download size={15} />} onClick={onExport} title={t("threadActions.export")} />
        <Button variant="secondary" iconOnly icon={<ExternalLink size={15} />} onClick={onPopOut} title={t("threadActions.openInNewWindow")} />
        <Button
          variant="secondary"
          iconOnly
          icon={<ListTodo size={15} className={taskSidebarVisible ? "text-accent" : ""} />}
          onClick={onToggleTaskSidebar}
          title={taskSidebarVisible ? t("threadActions.hideTaskPanel") : t("threadActions.showTaskPanel")}
        />
        <Button
          variant="secondary"
          iconOnly
          ...
          title={contactSidebarVisible ? t("threadActions.hideContactSidebar") : t("threadActions.showContactSidebar")}
        />
      </div>
