  ...
  return (
    ...
    >
                  ...
                  <>
                    ...
                    {isInbox && !collapsed && (
                      <span
                        ...
                        title={inboxViewMode === "split" ? t("sidebar.switchUnified") : t("sidebar.switchSplit")}
                  ...
                  {CATEGORY_ITEMS.map((cat) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="flex-1 truncate">{t("nav.cat." + cat.id)}</span>
                      </button>
                    );
                  })}
                </div>
            ...
            {!collapsed && labels.length > LABELS_COLLAPSED_COUNT && (
              ...
              >
                {labelsExpanded ? (
                  ...
                  <>
                    <ChevronDown size={12} />
                    <span>{t("sidebar.more", { count: labels.length - LABELS_COLLAPSED_COUNT })}</span>
                  </>
                )}
              </button>
            )}
      ...
      <InputDialog
        ...
        fields={[
          { key: "name", label: t("sidebar.smartFolderName"), placeholder: t("sidebar.smartFolderNamePlaceholder") },
          { key: "query", label: t("sidebar.smartFolderQuery"), placeholder: t("sidebar.smartFolderQueryPlaceholder") },
        ]}
      />
    ...
    <div className="px-3 py-2 border-t border-border-primary">
      {collapsed ? (
        ...
        <div className="text-xs text-text-secondary">
          {t(pendingOpsCount === 1 ? "sidebar.pendingChange" : "sidebar.pendingChanges", { count: pendingOpsCount })}
        </div>
      )}
    </div>
  );
