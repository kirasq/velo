...
const MIGRATIONS = [
  ...
  {
    version: 24,
    description: "POP3 support: account columns + message UIDL + retention",
    sql: `
      ALTER TABLE accounts ADD COLUMN pop3_host TEXT;
      ALTER TABLE accounts ADD COLUMN pop3_port INTEGER;
      ALTER TABLE accounts ADD COLUMN pop3_security TEXT;
      ALTER TABLE accounts ADD COLUMN pop3_retention_days INTEGER DEFAULT 30;
      ALTER TABLE messages ADD COLUMN pop3_uidl TEXT;
